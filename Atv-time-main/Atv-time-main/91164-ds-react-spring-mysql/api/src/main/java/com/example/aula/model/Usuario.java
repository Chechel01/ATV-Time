...
//    private int numCamisa;
    ...
    public @NotBlank(message = "Sexo é obrigatório.") String getSexo() {return sexo; }
    public void setSexo(@NotBlank(message = "Sexo é obrigatório.") String sexo) {this.sexo = sexo;}
